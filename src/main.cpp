...
uint256 hashGenesisBlock("0x36d334acc794de29569368a3a665e6ee26ec1c110d06ae9a92e046443d4fab48");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd5adbfb5430e0a7944e515d21d9fa680134e05b9894004809246d9a5d9a57a40");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 20 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04056dc0a0495feee4471e62f58904a9b5428cfba54b304fd3265b9e51491c29fccf50177ffb67105d701c18b88f68792e0d319895090c5b84b1ac7bb8ca173e41") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1532057521;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085371268;

        if (fTestNet)
        {
            block.nTime    = 1532057509;
            block.nNonce   = 385291187;
        }
	...
	if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x9c54722fb8c4e95e0cc898d886ff6aa410ca0fc4d565a31aef1611afe7f7393f"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc4, 0xb8, 0xd3 }; // Funcoin: increase each by adding 2 to bitcoin's value.
